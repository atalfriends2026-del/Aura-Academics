...
export const THEME_OPTIONS: ThemeOption[] = [
  {
    ...
    badgeLabel: "1. FEATURED • MULTI GALAXY",
    hasParticles: true,
    hasSpirals: true,
    paletteSample: [
  ...
  },
  {
    ...
    badgeLabel: "2. FEATURED • AI IN EDUCATION",
    hasParticles: true,
    hasSpirals: true,
    paletteSample: [
  ...
  },
  {
    ...
    badgeLabel: "3. FEATURED • AI IN MULTIPLE FIELDS",
    hasParticles: true,
    hasSpirals: true,
    paletteSample: [
  ...
  },
  {
    ...
    badgeLabel: "5. FEATURED • FOREST MODE",
    hasParticles: true,
    hasSpirals: true,
    paletteSample: [
  ...
  },
  {
    ...
    badgeLabel: "6. FEATURED • OCEAN MODE",
    hasParticles: true,
    hasSpirals: true,
    paletteSample: [
  ...
  },
  {
    ...
    badgeLabel: "7. FEATURED • CYBERPUNK NIGHT MARKET",
    hasParticles: true,
    hasSpirals: true,
    paletteSample: [
  ...
  {
    id: "tesla-future",
    name: "Tesla Self Driving Car",
    category: "ai-theme",
    tagline: "Tesla AI, Safety, Innovation & Autonomous Future",
    description: "Futuristic autonomous electric mobility theme featuring glowing AI Navigation telemetry radar, 360° sensors, Tesla Cybertruck Supercharger station, and smart city urban skyline.",
    primaryColor: "#e82127",
    secondaryColor: "#00f0ff",
    accentGlow: "rgba(0, 240, 255, 0.6)",
    previewGradient: "from-[#060b18] via-[#0b1c36] via-[#1a0814] to-[#030611]",
    badgeLabel: "8. FEATURED • TESLA SELF DRIVING CAR",
    hasParticles: true,
    hasSpirals: true,
    paletteSample: [
      { name: "Tesla Racing Red", hex: "#e82127", role: "primary" },
      { name: "Autopilot Cyan", hex: "#00f0ff", role: "secondary" },
      { name: "Navigation Radar Blue", hex: "#38bdf8", role: "accent" },
      { name: "Supercharger Glow", hex: "#60a5fa", role: "glow" },
      { name: "Autonomous Dark Matrix", hex: "#060b18", role: "surface" },
    ],
  },
  {
    id: "bmw-m8",
    name: "BMW M8",
    category: "ai-theme",
    tagline: "High-Performance Luxury M Power & Sunset Reflections",
    description: "Sleek glossy black BMW M8 Competition coupe luxury sports car on wet reflective asphalt with glowing golden yellow LED angel eye headlights and brutalist modern villa architecture at golden hour.",
    primaryColor: "#f59e0b",
    secondaryColor: "#3b82f6",
    accentGlow: "rgba(245, 158, 11, 0.6)",
    previewGradient: "from-[#090a0f] via-[#1a1410] via-[#241a0d] to-[#050608]",
    badgeLabel: "9. FEATURED • BMW M8",
    hasParticles: true,
    hasSpirals: true,
    paletteSample: [
      { name: "M Icon Amber Gold", hex: "#f59e0b", role: "primary" },
      { name: "Motorsport Blue", hex: "#3b82f6", role: "secondary" },
      { name: "M Power Crimson", hex: "#e11d48", role: "accent" },
      { name: "Sunset Gold Shimmer", hex: "#fbbf24", role: "glow" },
      { name: "Black Sapphire Metallic", hex: "#090a0f", role: "surface" },
    ],
  },
  {
    id: "light",
